...
<html>
  <head>
    ...
    <link rel="stylesheet" href="sjr.css">
  ...
  <body>
    ...
    <div id="menubar">
        <ul id="menu">
          ...
          <li class="#"><a href="sejarah.php">Sejarah</a></li>
    ...
    <div class="slideshow-container">
        <img class="slide active" src="https://i.ibb.co.com/rm3K0mB/Whats-App-Image-2024-10-03-at-08-48-31-1a7a3e0f.jpg" alt="Gambar 1">
        <img class="slide" src="https://i.ibb.co.com/SrS5DJ8/Whats-App-Image-2024-10-03-at-08-48-32-4266972a.jpg" alt="Gambar 2">
        <img class="slide" src="https://i.ibb.co.com/M5cJvT4/Whats-App-Image-2024-10-03-at-08-48-32-440a3eb1.jpg" alt="Gambar 3">
    </div>
  ...
  <div class="container">
    ...
    <div class="facilities">
        <div class="facility">
            <h3>Sejarah SMK GOLDEN</h3>
            <p>SMK Golden berdiri pada tahun 2015 dibawah naungan Yayasan Nurul Walidain T.H
            dibawah pimpinan Drs. H. A. Hanapi, M. Pd. I yang terletak di Jl. Letkol Atang Sanjaya RT 01/02 Desa Pasir Gaok Kecamatan Ranca Bungur Kabupaten Bogor
            Tujuan sekolah sebagai bagian dari tujuan pendidikan nasional,adalah meningkatkan kecerdasan, pengetahuan, kepribadian, akhlak mulia, serta keterampilan untuk hidup mandiri dan mengikuti pendidikan lebih lanjut, serta bagian dari tujuan pendidikan menengah kejuruan yaitu mempersiapkan tamatan yang berkualitas yang dapat diterima di Dunia kerja, sesuai dengan bidang keahliannya masing - masing, serta mampu mengikuti pendidikan ke tingkatan yang lebih tinggi
            </p>
        </div>
</div>
